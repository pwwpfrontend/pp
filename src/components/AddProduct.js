...
import { Package, Plus, X, DollarSign, Tag, Image as ImageIcon, FileText } from 'lucide-react';
...
const AddProduct = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Here you would call the API to add the product
        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2 flex items-center">
              <Plus className="w-8 h-8 mr-3 text-[#405952]" />
              Add New Product
            </h1>
